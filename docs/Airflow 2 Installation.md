...
- 비디오로 설치 과정을 데모하는 영상은 [여기](https://drive.google.com/file/d/1Q0XcZU7U0f4xRRYuwDKRkBfpv1zjkNN5/view?usp=share_link)를 참고
...
keeyong/data-engineering-batch14 repository에 있는 dags 폴더의 내용을 /var/lib/airflow/dags로 복사한다. 

```
sudo su airflow
cd ~/
git clone https://github.com/keeyong/data-engineering-batch14.git
cp -r data-engineering-batch14/dags/* dags
```
